...
exports.outgoing = function (req, res) {
    // console.log(req);
    console.log('Inside outgoing packet manifest doc..');
    var jsonContent = {
        reportName: "Outgoing Packet Manifest",
        logo: "",
    ...
    jsonContent.title = "Outgoing Packet Manifest Details";
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//outgoing.html', 'utf8', bodyReadResponse);
    }
