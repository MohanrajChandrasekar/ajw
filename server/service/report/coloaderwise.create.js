...
exports.coloaderwise = function (req, res) {
    ...
    // console.log(req);
    console.log('Inside Coloader Expense Detais doc..');
    var jsonContent = {
        reportName: "Coloader Expense Detais",
        logo: "",
        printedOn: moment().format('DD-MMM-YYYY')
    };
    jsonContent.tblData = req.body;
    console.log(jsonContent.tblData);
    jsonContent.title = "Coloader Expense Detais";
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//coloaderwise.html', 'utf8', bodyReadResponse);
    }
