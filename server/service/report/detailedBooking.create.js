...
exports.detailedBooking = function (req, res) {
    // console.log(req);
    console.log('Inside Detailed Booking doc..');
    var jsonContent = {
        reportName: "Detailed Booking",
        logo: "",
    ...
    jsonContent.title = "Detailed Booking Details";
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//detailedBooking.html', 'utf8', bodyReadResponse);
    }
