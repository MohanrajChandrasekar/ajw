...
exports.specialCustomerDetailedBooking = function (req, res) {
    // console.log(req);
    console.log('Inside Detailed Booking doc..');
    var jsonContent = {
        reportName: "Special Customer Detailed Booking",
        logo: "",
    ...
    jsonContent.title = "Special Customer Detailed Booking Details";
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//specialCustomerDetailedBooking.html', 'utf8', bodyReadResponse);
    }
