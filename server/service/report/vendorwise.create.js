...
exports.vendorwise = function (req, res) {
    ...
    // console.log(req);
    console.log('Inside Vendor Expense Details doc..');
    var jsonContent = {
        reportName: "Vendor Expense Details",
        logo: "",
        printedOn: moment().format('DD-MMM-YYYY')
    };
    jsonContent.tblData = req.body;
    console.log(jsonContent.tblData);
    jsonContent.title = "Vendor Expense Details";
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//vendorwise.html', 'utf8', bodyReadResponse);
    }
