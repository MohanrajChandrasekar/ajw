...
exports.weightBreakupByHawnNo = function (req, res) {
    var jsonContent = {
        ...
        reportName: "MASTER AIRWAY BILL NUMBER:" + req.body[0].secMawbno,
        logo: "",
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//weightBreakup.html', 'utf8', bodyReadResponse);
    }
