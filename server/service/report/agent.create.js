...
exports.agent = function (req, res) {
    // console.log(req);
    console.log('Inside Agent Delivery manifest doc..');
    var jsonContent = {
        reportName: "Agent Delivery Manifest",
        logo: "",
    ...
    jsonContent.title = "Agent Delivery Manifest Details";
    ...
    function footerReadResponse(err, htmldata) {
        ...
        fs.readFile('service//report//html//agent.html', 'utf8', bodyReadResponse);
    }
